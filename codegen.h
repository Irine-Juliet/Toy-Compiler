...
void HandleUnaryNegate(Node* rightNode, char* variableName);
void HandleFunctionCall(Node* rightNode);
void HandleVariableAssignment(Node* rightNode);
void HandleConstantAssignment(Node* rightNode, char* variableName);